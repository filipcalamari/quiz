      ...
      <Block className={"padding-section-small"} tag={"div"}>
        <Block className={"padding-global"} tag={"div"}>
          <Block className={"container-large"} tag={"div"}>
            <Block
              className={"content-box_default is-grey is-bgshape-ver1"}
              tag={"div"}
            >
              <Block className={"layout-row gap-xlarge"} tag={"div"}>
                ...
                >
                  <Block className={"width-60--desktop"} tag={"div"}>
                    <Block
                      className={
                        "layout-column-desktop gap-large footer_tablet-gap-increased"
                      }
                      tag={"div"}
                    >
                      ...
                      <Block className={"width-33--desktop"} tag={"div"}>
                        <Block
                          className={
                          ...
                          tag={"div"}
                        >
                          <Block className={"sizing-grow-tablet"} tag={"div"}>
                            <Block
                              className={"layout-row gap-medium is-align-start"}
                              tag={"div"}
                            >
                          ...
                          <Block
                            className={"footer_placeholder-of-link hide-tablet"}
                            tag={"div"}
                          />
                          <Block
                            className={
                              "layout-row gap-medium is-align-start sizing-grow-tablet"
                            }
                            tag={"div"}
                          >
                            <Block className={"text-weight-bold"} tag={"div"}>
                  ...
                  <Block className={"width-40--desktop"} tag={"div"}>
                    <Block
                      className={"layout-row gap-medium is-align-start"}
                      tag={"div"}
                    >
