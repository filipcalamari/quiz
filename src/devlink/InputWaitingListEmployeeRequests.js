...
export function InputWaitingListEmployeeRequests({
  ...
  const _styleVariantMap = {
    Base: "",
    "Grey background": "w-variant-cee2c951-11ef-9aaf-0cc9-89a86d0d42f6",
  };
  ...
  return (
    <FormWrapper className={`form_component ${_activeStyleVariant}`}>
      ...
      >
        <Block
          className={`input-container min-width-24 ${_activeStyleVariant}`}
          tag={"div"}
        >
          <FormTextInput
        ...
        <Block
          ...
          tag={"div"}
        >
          <Paragraph className={`padding-right-4 ${_activeStyleVariant}`}>
            {
