...
export function SectionCta({
  description = "Stop being a bottleneck. Try our time-off tracking system for 14 days for free and regain focus.",
  heading = "Get ready forefficiency",
}) {
  return (
      ...
      <Block className={"padding-section-small"} tag={"div"}>
        <Block className={"padding-global"} tag={"div"}>
          <Block className={"container-large"} tag={"div"}>
            <Block className={"content-box_default is-cta"} tag={"div"}>
              <Block
